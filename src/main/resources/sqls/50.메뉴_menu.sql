...
VALUES ('booking', '예약', '/jsp/pms/book/booking.jsp', '_self', 'Y', 'Y', 'Y');
-- 메뉴 생성
INSERT INTO MENU_M (MENU_ID, MENU_GRP_CD, MENU_NM, MULTI_LANGUAGE, PARENT_ID, LEVEL, SORT, PROG_CD, CREATED_AT, CREATED_BY, UPDATED_AT, UPDATED_BY )
VALUES (201, 'SYSTEM_MANAGER', '예약 등록', '{"ko":"예약 등록","en":"booking"}',  200, 1, 1, 'teach-grid', sysdate(), 'system', sysdate(), 'system');
-- 메뉴 권한
...
VALUES ('teach-grid-form', '실습용 그리드 폼', '/jsp/pms/book/state.jsp', '_self', 'Y', 'Y', 'Y', 'Y');
INSERT INTO PROG_M (PROG_CD, PROG_NM, PROG_PH, TARGET, AUTH_CHECK, SCH_AH, SAV_AH, DEL_AH )
...
-- 메뉴 그룹 - 프론트
INSERT INTO MENU_M (MENU_ID, MENU_GRP_CD, MENU_NM, MULTI_LANGUAGE, PARENT_ID, LEVEL, SORT, PROG_CD, CREATED_AT, CREATED_BY, UPDATED_AT, UPDATED_BY )
VALUES (200, 'SYSTEM_MANAGER', '교육용 샘플', '{"ko":"교육용 셈플","en":"교육용 샘플"}',  null, 0, 99, null, sysdate(), 'system', sysdate(), 'system');
